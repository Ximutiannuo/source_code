...
Sub saveVFACTto_DB()
    ...
    '================== 数据准备 ==================
    fpath = "C:\Users\" & Environ("username") & _
          "\OneDrive\Ust-Luga GCC\Procedures\REPORTS\RECEIVE\VFACT\"
...
CloseWorkbook:
    ...
    '? 优化数据库更新
    wbPath = "C:\Users\" & Environ("username") & _
           "\OneDrive\Ust-Luga GCC\Procedures\REPORTS\GCC-OPG-PLAN-REPORT-VFACT.xlsm"
